...
function normalizeSingleEditorEntry(){
  document.title=document.title.replace(/v0\.15\.[0-7]/g,VERSION);
  document.querySelectorAll('.page-head small').forEach(el=>{el.textContent=el.textContent.replace(/v0\.15\.[0-7]/g,VERSION)});
